# Ballerina AI Agent Module Examples: HTTP API tools using HttpServiceToolKit

## Overview

This example demonstrates how to use API resources easily using the `HttpTool` definition of the Agent.
